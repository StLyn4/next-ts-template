...
const dependencies = Object.keys({
  ...
  ...(project.peerOptionalDependencies ?? {}),
});
...
module.exports = {
  ...
  // Дополнительные типы файлов для проверки
  enableFiletypes: ['dotenv'],

  // В этом файле мы добавляем лишь слова с названий зависимостей.
  // Остальные пользовательские слова должно быть добавлено в spelling-dict.dic
